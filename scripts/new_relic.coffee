...
module.exports = (robot) ->
  robot.respond /newrelic me/i, (msg) ->
    accountId = process.env.HUBOT_NEWRELIC_ACCOUNT_ID #98007
    appId     = process.env.HUBOT_NEWRELIC_APP_ID #26550
    apiKey    = process.env.HUBOT_NEWRELIC_API_KEY #78fd8e3a88a1ab1a4e26184720902d83d02616af0dec1b1
